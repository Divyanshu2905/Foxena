...
export default function Home({scrollXProgress}) {
  ...
  return (
    <div className="mainsho">
      <motion.img className="imgsho" src="/main1.png" style={{ x: x1 }} />
      <motion.img className="imgsho" src="/main2.png" style={{ x: x2 }} />
      <motion.img className="imgsho" src="/main3.png" style={{ x: x3 }} />
      <motion.img className="imgsho" src="/main4.png" style={{ x: x4 }} />
    </div>
  );
}
