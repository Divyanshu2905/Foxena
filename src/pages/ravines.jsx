...
export default function Ravines() {
  return (
    <div className="mains">
        <a href="http://omnixs.foxena.com/"><img className="imgrav" src='/rvn1.png'></img></a>
        ...
        <div className="tops"><a className="links" href="http://omnixs.foxena.com/" >ONLINE IDENTITY<br/>& WEB SERVICES</a></div>
    </div>
  );
}