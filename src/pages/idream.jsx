...
export default function Idream({scrollXProgress}) {
  ...
  return (
    <div className="maindrm">
        <a href="http://idreams.foxena.com/"><motion.img className="imgdrmii" style={{ zIndex:"2",x:x1}} src='/idrm1.png'></motion.img></a>
        ...
        <div className="tops"><motion.a className="linksdrm" href="http://idreams.foxena.com/" style={{x:x8}} >ANIMATION<br/>& VFX STUDIO</motion.a></div>
    </div>
  );
}