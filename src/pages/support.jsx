    ...
    return(
        ...
        <div className="list-container" style={{paddingTop:"5%"}}>
          <ul className="list-column">
            ...
            <FontAwesomeIcon icon={faFortAwesome} size="2xl" style={{color: "#63E6BE", marginRight: "10px"}} className="fonts" />
              <a href="https://support.foxena.com/authentication/login"><span className="list-text">Support Hub</span> </a>
            </li>
            <li className="list-item">
            <FontAwesomeIcon icon={faFacebookF} size="2xl" style={{color: "#030bfc", marginRight: "30px"}} className="fonts" />
              <a href="https://www.facebook.com/foxenacorp"><span className="list-text">Facebook</span></a>
            </li>
            <li className="list-item">
            <FontAwesomeIcon icon={faSkype} size="2xl" style={{color: "#74C0FC", marginRight: "15px"}} className="fonts"/>
              <a href="skype:ashisharma13?chat"><span className="list-text">Skype Chat</span></a>
            </li>
          </ul>
          <ul className="list-column">
            <li className="list-item">
            <FontAwesomeIcon icon={faTwitter} size="2xl" style={{color: "#74C0FC", marginRight: "25px"}} className="fonts" />
              <a href="https://twitter.com/foxenacorp"><span className="list-text">Twitter</span></a>
            </li>
            <li className="list-item">
            <FontAwesomeIcon icon={faLinkedinIn} size="2xl" style={{color: "#004bcc",marginRight: "25px"}} className="fonts"/>
              <a href="https://www.linkedin.com/company/10466714"><span className="list-text">LinkedIN</span></a>
            </li>
            <li className="list-item">
            <FontAwesomeIcon icon={faGooglePlusG} size="2xl" style={{color: "#f75555",marginRight: "15px"}}  className="fonts"/>
